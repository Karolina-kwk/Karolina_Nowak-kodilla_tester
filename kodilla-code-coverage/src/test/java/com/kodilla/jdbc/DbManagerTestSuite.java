...
public class DbManagerTestSuite {
    ...
    public void testSelectUsersAndPosts() throws SQLException {
        ...
        String sql = "INSERT INTO USERS(FIRSTNAME, LASTNAME) VALUES ('Anna', 'B')";
        statement.executeUpdate(sql);
        sql = "INSERT INTO USERS(FIRSTNAME, LASTNAME) VALUES ('Marzena', 'S')";
        statement.executeUpdate(sql);

        sql = "INSERT INTO POSTS(USER_ID, BODY) VALUES (1, 'Testing Post1!')";
        statement.executeUpdate(sql);
        sql = "INSERT INTO POSTS(USER_ID, BODY) VALUES (3, 'Testing Post2')";
        statement.executeUpdate(sql);
        sql = "INSERT INTO POSTS(USER_ID, BODY) VALUES (3, 'Testing Post22')";
